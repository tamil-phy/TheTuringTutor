...
# ------------------------------------------------------------
print("=" * 60)
print("RNN LANGUAGE MODEL - Standalone Version")
print("=" * 60)
print("Learns to predict the next word given a 3‑word context.")
print("The RNN compresses the entire history into a hidden state.\n")
...
print(f"RNN prediction for next word: '{predicted_word}'")
print("\nNote: The RNN generalizes even if the exact 3‑word sequence was never seen in training.")